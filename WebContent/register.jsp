...
.login_btn input{ overflow:hidden; margin:20px 0px; margin-top:10px; margin-left:60px;}
</style>
</head>
<body>
<div class="ui_header">
		...
		<div class="member_register_rege">
			<div class="meber_register_list">
				...
				<div class="meber_register_list_m">
					<input class="input_register01 txtAdmin" type="text" name="username">
			...
			<div class="meber_register_list">
				...
				<div class="meber_register_list_m">
					<input class="input_register01 txtPassword" type="password" name="password">
			...
			<div class="meber_register_list">
				...
				<div class="meber_register_list_m">
					<input class="input_register01 txtPassword" type="password" name="address">
					<div class="divPassword">&nbsp;</div>
				</div>
			</div>
			<div class="meber_register_list">
				...
				<div class="meber_register_list_m">
					<input class="input_register01 txtPassword" type="password" name="phone">
					<div class="divPassword">&nbsp;</div>
				</div>
			</div>
			<div class="meber_register_list">
			...
			<div class="login_btn">
				<input type="submit" class="btn_zong big" value="提交">
				<input type="reset" class="btn_zong big" value="清空">
			</div>
			</div>
	</form>
	</div>
