...
<%@ page import="java.util.*,pb.db.*,pb.Itemattdealer"%>
<%
...
<div class="w1200 clearfix overflow_v"> 
        <div class="my_order_table" >
        	<a  href="item_att_ins.jsp" id="btn" class="btn_gray btn_fen_2">
	             <span>新增</span>
            ...
            <tr class="bor_bnone">
              ...
              <c:forEach items="${list}" var ="list" varStatus="sta">  
        			...
        			<td><a class="font_brown">${list.attrigid}</a></td>        	
      	 			<td>
	      	  			<a onclick="deletep(${list.iaid})" class="alert_del_goods font_brown">删除</a>
					</td>
					</tr>
        	</c:forEach> 
        	 </table>
