...
<body>
	<div class="w990">
		<div class="place_mid">
			...
			<form id='itemform' action="ItemupdServlet" method="post"  enctype="multipart/form-data">
			<table>
			...
			<div class="lofin_reg">
				...
				<div class="login_pass_input">
					<input type="text" name ="itemid" value =${listi.itemid}  readonly= "true">
				</div>
				<div class="login_pass_span">
					<span>
						商品名称
				...
				<div id="preview">
   					 <img width="220" height="220"  src=" <%=request.getAttribute("basePath")%>${listi.imgurl}">
   				</div>
         		 </div>
