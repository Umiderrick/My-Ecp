...
{	
	$.get("ThitypeupdServlet",{"thitypeid":thitypeid});
...
<div class="w1200 clearfix overflow_v"> 
    <div class="content_wrap">
      <div class="my_order">
        ...
        <div class="clearfix ac"><a  href="thi_type_insert.jsp" id="btn" class="btn_gray btn_fen_2">
	             <span>新增</span>
          ...
          <table width="918" border="0" cellspacing="0" cellpadding="0" class="table_user">
        	...
        	<td><a class="font_brown">${list.thitypename}</a></td>
      	 	<td>
	      	  		<a onclick="deletep('${list.thitypeid}')" class="alert_del_goods font_brown">删除</a>
	          		|
	           		<a href="thi_type_update.jsp" onclick="update('${list.thitypeid}');" class="alert_del_goods font_brown">修改</a>
			</td>
			</tr>
        	</c:forEach>  
        	 </table>
