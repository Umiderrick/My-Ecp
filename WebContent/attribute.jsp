...
<%@ page import="java.util.*,pb.db.*,pb.Attributedealer"%>
<%
...
{	
	$.get("AttributeupdServlet",{"attid":attid});
      ...
      <div class="my_order">
        <div class="my_order_table" >
        	<a  href="attribute_ins.jsp" id="btn" class="btn_gray btn_fen_2">
	     	...
	     	<a  href="attributeg.jsp" id="btn" class="btn_gray btn_fen_2">
	             <span>属性子表管理</span>
	              <i class="icon_graycircle"></i></a>
	     	<a  href="thi_att.jsp" id="btn" class="btn_gray btn_fen_2">
	             <span>三级类别属性管理</span>
	              <i class="icon_graycircle"></i></a>
          ...
          <table width="800" border="0" cellspacing="0" cellpadding="0" class="table_user">
        	...
        	<td><a class="font_brown">${list.attname}</a></td>        	
      	 	<td>
	      	  		<a onclick="deletep('${list.attid}')" class="alert_del_goods font_brown">删除</a>
	          		|
	           		<a href="attribute_upd.jsp" onclick="update('${list.attid}');" class="alert_del_goods font_brown">修改</a>
			</td>
			</tr>
        	</c:forEach>  
        	 </table>
