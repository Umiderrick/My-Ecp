			...
			<div class="my_order">
				<div class="my_order_table">
					<div class="clearfix ac">
						<a href="attributeg_ins.jsp" id="btn" class="btn_gray btn_fen_2">
						...
						<tr class="bor_bnone">
							...
							<c:forEach items="${listg}" var="listgA" varStatus="sta2">
								<tr>
									...
									<td><a onclick="deletep('${listgA.attrigid}')">删除</a> | <a
										href="attributeg_upd.jsp"
										onclick="update('${listgA.attrigid}')">修改</a></td>
								</tr>
							</c:forEach>
					</table>
				</div>
