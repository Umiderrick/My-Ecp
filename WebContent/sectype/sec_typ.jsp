...
<%@ page import="java.util.*,pb.db.*,pb.secondtype.Sectypedealer"%>
<%
			...
			<div class="my_order">
				<div class="my_order_table">
					<div class="clearfix ac">
						<a href="sec_type_insert.jsp" id="btn" class="btn_gray btn_fen_2"><span>新增</span><i
						...
						<tr class="bor_bnone">
							...
							<c:forEach items="${list}" var="list" varStatus="sta">
								<tr>
									...
									<td><a onclick="deletep('${list.sectypeid}')">删除</a> | <a
										href="sec_type_update.jsp"
										onclick="update('${list.sectypeid}')">修改</a></td>
								</tr>
							</c:forEach>
					</table>
				</div>
