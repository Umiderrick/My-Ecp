...
<%@ page import="java.util.*,pb.db.*,pb.thiatt.Thiattdealer"%>
<%
...
<body>
	...
	<div class="w1200 clearfix overflow_v">
		<div class="my_order_table">
			<a href="thi_att_ins.jsp" id="btn" class="btn_gray btn_fen_2"> <span>新增</span>
			...
			<table width="800" border="0" cellspacing="0" cellpadding="0"
				...
				<c:forEach items="${list}" var="list" varStatus="sta">
					<tr>
						...
						<td><a onclick="deletep('${list.thitypeid}','${list.attid}')">删除</a>
						</td>
					</tr>
				</c:forEach>
			</table>
