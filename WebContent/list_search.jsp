...
function show(itemid){
	$.post("ItemshowServlet",{"itemid":itemid},window.location.href='pshow.jsp');
}
function listsearch()
...
{	
	$.post("ListSearchServlet",{ "attrigid": attrigid },window.location.href='list_search.jsp');
	}			
</script>
<style>
  ...
  <div class="select_title">
   ...
   <div class="product_filter_goods">
    ...
    <c:forEach items="${list}" var ="list" varStatus="sta">  
    	<li class="fore">
          <div class="p_img"> <a onclick="show('${list.itemid}')" > <img width="220" height="220"  src="<%=request.getAttribute("basePath")%>${list.imgurl}"></a> </div>
          <div class="rate">${list.itemid} <a><span class="title">${list.itemname}</span></a></div>
          <div class="p_price">
